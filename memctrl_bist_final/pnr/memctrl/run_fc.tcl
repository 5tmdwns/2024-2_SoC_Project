...
set_pg_via_master_rule pgvia_1x2 -via_array_dimension {1 2} ;#set via_master_rule {2 1} = 1행 2열 가로2개 세로1개
...
set_app_options -name route.global.timing_driven -value high ;# enables or disables timing-driven global routing
set_app_options -name route.global.crosstalk_driven -value false ;# enables or disables crosstalk-driven global routing
set_app_options -name route.track.timing_driven -value high ;# enables or disables timing-driven track assignment
set_app_options -name route.track.crosstalk_driven -value false ;# enables or disables crosstalk-driven track assignment
set_app_options -name route.detail.timing_driven -value high ;# This app option specifies whether timing-driven routing is enabled
set_app_options -name route.detail.force_max_number_iterations -value true ;# This app option controls whether the max number of iterations must be run when DRCs do not converge
...
#create_via_def -is_default -lower_layer M1 -upper_layer M2 -cut_size {0.020 0.020} -lower_enclosure {0.015 0.015} -cut_layer VIA1 -upper_enclosure {0.015 0.015} VIA12_thin
...
### search_and_repair
route_detail -incremental true -initial_drc_from_input true -max_number_iterations 100 ;# This command performs detail routing on a block
