...
create_via_def -is_default -lower_layer M1 -upper_layer M2 -cut_size {0.050 0.050} -lower_enclosure {0.015 0.015} -cut_layer VIA1 -upper_enclosure {0.015 0.015} VIA12_thin3
...
create_via_def -is_default -lower_layer M1 -upper_layer M2 -cut_size {0.10 0.10} -lower_enclosure {0.005 0.02} -cut_layer VIA1 -upper_enclosure {0.005 0.02} VIA12_fat2
