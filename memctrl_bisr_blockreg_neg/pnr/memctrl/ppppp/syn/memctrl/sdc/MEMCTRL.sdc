...
#create_clock -name "CE" -period 20 -waveform {0 10} [get_ports CE]
#set_clock_latency 1 [get_clock CE]
#set_clock_uncertainty -setup 0.3 [get_clock CE]
#set_clock_uncertainty -hold 0.1 [get_clock CE]
#set_clock_transition 0.5 [get_clock CE]

#GENCLK
create_generated_clock -name "CLOCKCE" -divide_by 2 -source [get_ports CLK] [get_pins UFSM/MEM_CE_reg/Q]
...
set_input_delay 1 -clock [get_clock CE] [remove_from_collection [all_inputs] [get_port {CLK RSTN}]]
...
set_output_delay 1 -clock [get_clock CE] [all_outputs]
