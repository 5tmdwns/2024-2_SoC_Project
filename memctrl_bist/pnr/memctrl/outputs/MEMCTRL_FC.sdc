################################################################################
#
# Design name:  MEMCTRL_08_FILL
#
# Created by fc write_sdc on Mon Dec 16 15:29:18 2024
#
################################################################################
...
# /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 5; \
#   /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 6; \
#   /mnt/home/soc32/soc/proj7/p1/pnr/memctrl/run_fc.tcl, line 894
create_clock -name CLOCK -period 10 -waveform {0 5} [get_ports {CLK}]
# /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 12; \
#   /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 13; \
#   /mnt/home/soc32/soc/proj7/p1/pnr/memctrl/run_fc.tcl, line 894
create_generated_clock -name CLOCKCE -divide_by 2 -source [get_pins \
    {UFSM/I_66/Y}] [get_pins {UFSM/MEM_CE}]
# /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 18; \
#   /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 19; \
#   /mnt/home/soc32/soc/proj7/p1/pnr/memctrl/run_fc.tcl, line 894
create_generated_clock -name CLOCKB -divide_by 1 -invert -source [get_ports \
    {CLK}] [get_pins {UFSM/I_66/Y}]
set_propagated_clock [get_clocks {CLOCK}]
set_propagated_clock [get_clocks {CLOCKCE}]
set_propagated_clock [get_clocks {CLOCKB}]
# /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 5; \
#   /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 47
group_path -name CLOCK -weight 5 -to [get_clocks {CLOCK}]
# /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 43; \
#   /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 48
group_path -name INPUTS -from [get_ports {ADDR[15] ADDR[14] ADDR[13] ADDR[12] \
    ...
    IDATA[3] IDATA[2] IDATA[1] IDATA[0] OEB RSTN WEB BIST_EN BIST_MODE[2] \
    BIST_MODE[1] BIST_MODE[0]}]
# /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 44; \
#   /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 49
group_path -name OUTPUTS -to [get_ports {ODATA[7] ODATA[6] ODATA[5] ODATA[4] \
    ODATA[3] ODATA[2] ODATA[1] ODATA[0] BIST_PASS}]
# /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 45; \
#   /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 50
group_path -name COMBO -from [get_ports {ADDR[15] ADDR[14] ADDR[13] ADDR[12] \
    ADDR[11] ADDR[10] ADDR[9] ADDR[8] ADDR[7] ADDR[6] ADDR[5] ADDR[4] ADDR[3] \
    ADDR[2] ADDR[1] ADDR[0] CE CLK CSB IDATA[7] IDATA[6] IDATA[5] IDATA[4] \
    IDATA[3] IDATA[2] IDATA[1] IDATA[0] OEB RSTN WEB BIST_EN BIST_MODE[2] \
    BIST_MODE[1] BIST_MODE[0]}] -to [get_ports {ODATA[7] ODATA[6] ODATA[5] \
    ODATA[4] ODATA[3] ODATA[2] ODATA[1] ODATA[0] BIST_PASS}]
...
# /mnt/home/soc32/soc/proj7/p1/pnr/memctrl/run_fc.tcl, line 567
set_voltage 0.95 -object_list {VDD}
# /mnt/home/soc32/soc/proj7/p1/pnr/memctrl/run_fc.tcl, line 568
...
# -origin user
set_clock_latency -min 0.828438 [get_clocks {CLOCK}]
# -origin user
set_clock_latency -max 0.922127 [get_clocks {CLOCK}]
...
set_clock_uncertainty -setup 0.3 [get_clocks {CLOCKB}]
set_clock_uncertainty -hold 0.1 [get_clocks {CLOCKB}]
set_clock_transition 0.5 [get_clocks {CLOCK}]
set_clock_transition 0.5 [get_clocks {CLOCKCE}]
set_clock_transition 0.5 [get_clocks {CLOCKB}]
# /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 36
...
# /mnt/home/soc32/soc/proj7/p1/syn/memctrl/sdc/MEMCTRL.sdc, line 30
...
set_max_transition 0.4 [get_clocks {CLOCK}] -clock_path
set_max_transition 0.4 [get_clocks {CLOCKCE}] -clock_path
set_max_transition 0.4 [get_clocks {CLOCKB}] -clock_path
